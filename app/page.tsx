...
<section className="relative py-16 border-b border-gray-100 overflow-hidden">
  ...
  <div className="relative container mx-auto px-4">
    <div className="max-w-4xl mx-auto text-center">
      <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full mb-4 shadow-sm border border-white/20">
      ...
      <h1 className="text-4xl md:text-5xl font-comic text-white mb-4 drop-shadow-lg">
