            ...
            <div className="relative h-96 md:h-[600px] rounded-3xl overflow-hidden shadow-2xl border border-gray-200">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <a
                  ...
                  className="pointer-events-auto bg-white/90 backdrop-blur-sm hover:bg-white text-gray-900 px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-2 border border-gray-200"
                >
